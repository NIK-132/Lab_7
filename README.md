...
- Создать множество `allFactories`, содержащее все фабрики из перечня.
- Для каждого покупателя создать множество `HashSet<string>` купленных им мебели из фабрик. Все такие множества сохранить в список `buyerSets`.
- Все фабрики, где покупатель купил мебель - это пересечение множеств всех покупателей. (`intersection`)
- Фабрики, где мебель была куплена хотя бы одним - это объединение множеств всех покупателей. (`union`)
- Фабрики, где мебель была не купленна никем - это разность `allFactories \ union`.
- Фабрики, где мебель была купленна некоторыми (но не всеми) - это разность `union \ intersection`. 
